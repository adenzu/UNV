...
public class NonControllableBoat : MonoBehaviour
{
    ...
    private void FixedUpdate()
    {
        ...
        if (_timer < 0)
        {
            _rudderAngle = Random.Range(-_rudderAngleRange, _rudderAngleRange);
            _timer = _rudderAngleChangeInterval;
        }
        _rigidbody.velocity = transform.forward * _speed;
        _rigidbody.angularVelocity = Vector3.up * _speed * _angularSpeedScale * _rudderAngle;
    }
}
